...
(function(d) {
    ...
    ):"object"===typeof exports?module.exports=function(n,
    o) {
        n||(n=window);
...
this.c.dom.collection;
                        ...
                        k.init&&k.init.call(g.button(p.node),
                        g,
                        d(p.node),
                        k);
                        h++
        ...
        b) {
            ...
            this.s.dt.settings()[0].iTabIndex).attr("aria-controls",
            this.s.dt.table().node().id).on("click.dtb",
            function(b) {
                b.preventDefault();
...
[],
    ...
    b) {
        ...
        b) {
            ...
            else"object"===typeof a&&a.nodeName&&(i=d.inArray(a,
            f),
            -1!==i&&c.push( {
                inst: b, node: f[i]
            }
    ...
    d.extend(j,
    {
        collection: {
            ...
            e) {
                ...
                c>g&&e._collection.css("left",
                a.left-(c-g))):(a=e._collection.height()/2,
                a>d(n).height()/2&&(a=d(n).height()/2),
                e._collection.css("marginTop",
                -1*a));
                e.background&&l.background(!0,
    ...
    i.Api.registerPlural("buttons().action()",
    "button().action()",
    function(a) {
        return a===m?this.map(function(a) {
    ...
    i.Api.registerPlural("buttons().nodes()",
    "button().node()",
    function() {
        var a=d();
    ...
    i.Api.registerPlural("buttons().containers()",
    "buttons().container()",
    function() {
    ...
    c) {
        ...
        d('<div id="datatables_buttons_info" class="dt-button-info"/>').html(a?"<h2>"+a+"</h2>":"").append(d("<div/>")["string"===typeof b?"html":"append"](b)).css("display",
        "none").appendTo("body").fadeIn();
...
b.column(a).header();
            ...
            n++) {
                ...
                q<j;
                q++)o[q]=c.format.body(h[m], n, q, f[m]), m++;
                l[n]=o
            }
            return {
