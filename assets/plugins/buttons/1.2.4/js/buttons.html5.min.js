(function(i) {
    ...
    ):"object"===typeof exports?module.exports=function(g,
    k,
    q,
    r) {
        g||(g=window);
...
p) {
        ...
        i.each(c, function(c, b) {
            if(i.isPlainObject(b)) {
                ...
                if(s) {
                    ...
                    for(h=m.length;
                    f<h;
                    f++)g=b.createAttribute(m[f].name.replace(":",
                    "_dt_b_namespace_token_")),
                    g.value=m[f].value,
                    e.setAttributeNode(g)
                }
                e=v.serializeToString(b);
                s&&(-1===e.indexOf("<?xml")&&(e='<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'+ e),
    ...
    c) {
        ...
        e<f&&!(b=a.body[e][c].toString(), -1!==b.indexOf("\n")?(b=b.split("\n"), b.sort(function(a, b) {
            return b.length-a.length
        }
        ),
        b=b[0].length):b=b.length,
        b>d&&(d=b),
        40<d);
        e++);
        d*=1.3;
    ...
    if("undefined"===typeof h||"undefined"!==typeof navigator&&/MSIE [1-9]\./.test(navigator.userAgent))o=void 0;
        ...
        var t=h.document.createElementNS("http://www.w3.org/1999/xhtml", "a"), J="download"in t, K=/constructor/i.test(h.HTMLElement)||h.safari, A=/CriOS\/[\d]+/.test(navigator.userAgent), L=function(a) {
        ...
        C=function(a) {
            ...
            .*charset\s*=\s*utf-8/i.test(a.type)?new Blob([String.fromCharCode(65279), a], {
                type: a.type
            }
            ):a
        }
        ...
        d) {
            ...
            setTimeout(function() {
                ...
                i.onloadend=function() {
                    var a=A?i.result: i.result.replace(/^data: [^;
                    ]*;
...
b.DONE;
            ...
            d?h.location.href=e:h.open(e,
            "_blank")||(h.location.href=e),
            b.readyState=b.DONE,
            f(),
            B(e)
        }
        ,
        j=D.prototype;
        "undefined"!==typeof navigator&&navigator.msSaveOrOpenBlob?o=function(a,
        c,
        d) {
            c=c||a.name||"download";
            d||(a=C(a));
        ...
        j.WRITING=1,
        j.DONE=2,
        j.error=j.onwritestart=j.onprogress=j.onwrite=j.onabort=j.onerror=j.onwriteend
null,
        o=function(a,
        c,
        d) {
    ...
    c) {
        for(var d=E(c), b=a.buttons.exportData(c.exportOptions), e=c.fieldBoundary, f=c.fieldSeparator, i=RegExp(e, "g"), m=c.escapeChar!==p?c.escapeChar: "\\", h=function(a) {
            ...
            c<d;
            c++)0<c&&(b+=f), b+=e?e+(""+a[c]).replace(i, m+e)+e: a[c];
            return b
        }
        ,
        ...
        x++)w.push(h(b.body[x]));
        return {
            str: g+w.join(d)+k, rows: w.length
        }
    }
    ,
    G=function() {
    ...
    l.ext.buttons.copyHtml5= {
        ...
        b) {
            ...
            f=i("<span>"+c.i18n("buttons.copyKeys",
            "Press <i>ctrl</i> or <i>?</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.")+"</span>").append(d);
    ...
    l.ext.buttons.excelHtml5= {
        ...
        b) {
            ...
            d=function(a) {
                ...
                b++) {
                    ...
                    if(!(null===a[b]||a[b]===p||""===a[b])) {
                        a[b]=i.trim(a[b]);
                        for(var l=0, o=H.length;
                        l<o;
                        l++)if(g=H[l], a[b].match&&a[b].match(g.match)) {
                            j=a[b].replace(/[^\d\.\-]/g, "");
                            g.fmt&&(j=g.fmt(j));
                            j=n(f, "c", {
                                attr: {
                        ...
                        j||("number"===typeof a[b]||a[b].match&&a[b].match(/^-?\d+(\.\d+)?$/)&&!a[b].match(/^0\d+/)?j=n(f,
                        "c",
                        {
                            attr: {
                                t: "n", r: d
            ...
            f).prepend(d);
            j=0;
            for(l=c.header.length;
            j<l;
            j++)d.appendChild(n(f,
            "col",
            {
                attr: {
                    min: j+1, max: j+1, width: I(c, j), customWidth: 1
                }
            }
            ));
...
typeof a?a: a+"", style: "tableFooter"
            ...
            b.message&&a.content.unshift( {
                text: "function"==typeof b.message? b.message(c, d, b): b.message, style: "message", margin: [0, 0, 0, 12]
            }
            );
            b.title&&a.content.unshift( {
                text: N(b, !1), style: "title", margin: [0, 0, 0, 12]
            }
            );
            b.customize&&b.customize(a,
            b);
